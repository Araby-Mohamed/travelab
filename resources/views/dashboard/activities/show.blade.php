                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <div class="text_view">
                                    <p><strong>Cost: </strong> {{ $data->cost . ' ' . $data->package->user->currency->code }}</p>
                                </div>
                                <div class="text_view">
                                ...
                                <div class="text_view">
                                    <p><strong>Links: </strong> <a href="{{ route('dashboard.links',$data->id) }}" title="Links" class="btn btn-success"><i style="color: #fff;font-size: 15px;" class="fa fa-link"></i></a></p>
                                </div>
