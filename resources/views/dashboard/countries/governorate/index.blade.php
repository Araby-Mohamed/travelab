        ...
        <div class="page-content">
            <div class="page-head">
                ...
                @permission('create-country')
                    <a class="add_admins" title="Add Currency" href="{{ route('dashboard.governorate.create',$country->id) }}"><i class="icon-plus"></i></a>
                @endpermission
            </div>
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="{{ route('dashboard.country') }}">Country</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span class="active">{{ $country->title }}</span>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span class="active">Governorates</span>
                </li>
            </ul>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @permission('delete-country')
                                <form action="{{ route('dashboard.governorate.deletes') }}" method="post" id="deletesData">
                                    @csrf
                            @endpermission
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            @permission('update-country')
                                                                                <a href="{{ route('dashboard.governorate.edit', $get->id) }}" title="{{ __('lang.edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                                            @endpermission
                                                                            @permission('delete-country')
                                                                                <a href="javascript:;" title="{{ __('lang.delete') }}" data-id="{{ route('dashboard.governorate.delete', $get->id) }}" class="btn btn-danger confirmDeleteItem"><i class="fa fa-trash"></i></a>
                                                                            @endpermission
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
