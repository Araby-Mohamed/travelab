        ...
        <div class="page-content">
            <div class="page-head">
                ...
                @permission('create-currency')
                    <a class="add_admins" title="Add Currency" href="{{ route('dashboard.currency.create') }}"><i class="icon-plus"></i></a>
                @endpermission
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="search-content">
                        <form action="{{ route('dashboard.currency') }}" method="get" id="searchForm">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @permission('delete-currency')
                                <form action="{{ route('dashboard.currency.deletes') }}" method="post" id="deletesData">
                                    @csrf
                            @endpermission
                                                            ...
                                                            <table style="margin-top: 10px;" class="table table-bordered table-striped table-condensed flip-content">
                                                                ...
                                                                @foreach($data as $get)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $get->code }}</td>
                                                                        <td>
                                                                            @permission('update-currency')
                                                                                <a href="{{ route('dashboard.currency.edit', $get->id) }}" title="{{ __('lang.edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                                            @endpermission
                                                                            @permission('delete-currency')
                                                                                <a href="javascript:;" title="{{ __('lang.delete') }}" data-id="{{ route('dashboard.currency.delete', $get->id) }}" class="btn btn-danger confirmDeleteItem"><i class="fa fa-trash"></i></a>
                                                                            @endpermission
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
