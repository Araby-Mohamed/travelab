    ...
    <div class="page-content-wrapper admins">
        <div class="page-content">
            <div class="page-head">
                ...
                @permission('create-interests')
                    <a class="add_admins" title="Add Currency" href="{{ route('dashboard.interests.create') }}"><i class="icon-plus"></i></a>
                @endpermission
            </div>
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span class="active">Interests</span>
                </li>
            </ul>
            <div class="row">
                <div class="col-md-12">
                    <div class="search-content">
                        <form action="{{ route('dashboard.interests') }}" method="get" id="searchForm">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @permission('delete-interests')
                                <form action="{{ route('dashboard.interests.deletes') }}" method="post" id="deletesData">
                                    @csrf
                            @endpermission
                                    <div class="portlet light bordered">
                                        <div class="portlet-title tabbable-line">
                                            <div class="caption caption-md">
                                                ...
                                                <span class="caption-subject font-blue-madison bold uppercase">Interests</span>
                                            </div>
                                            @permission('delete-interests')
                                                            ...
                                                            <table style="margin-top: 10px;" class="table table-bordered table-striped table-condensed flip-content">
                                                                ...
                                                                @foreach($data as $get)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $get->title }}</td>
                                                                        <td>
                                                                            @permission('update-interests')
                                                                                <a href="{{ route('dashboard.interests.edit', $get->id) }}" title="{{ __('lang.edit') }}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                                            @endpermission
                                                                            @permission('delete-interests')
                                                                                <a href="javascript:;" title="{{ __('lang.delete') }}" data-id="{{ route('dashboard.interests.delete', $get->id) }}" class="btn btn-danger confirmDeleteItem"><i class="fa fa-trash"></i></a>
                                                                            @endpermission
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
